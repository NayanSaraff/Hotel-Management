...
CREATE TABLE BOOKINGS (
    ...
    BOOKING_SOURCE      VARCHAR2(20)    DEFAULT 'STAFF' NOT NULL
                            CONSTRAINT chk_booking_source CHECK (BOOKING_SOURCE IN ('STAFF','PORTAL')),
    SEEN_BY_STAFF       NUMBER(1)       DEFAULT 1 NOT NULL,
